...
-- Schema sql7147869
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sql7147869` DEFAULT CHARACTER SET utf8 ;
USE `sql7147869` ;

-- -----------------------------------------------------
-- Table `sql7147869`.`TRAINS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`TRAINS` (
...
-- -----------------------------------------------------
-- Table `sql7147869`.`WAGONS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`WAGONS` (
  ...
  CONSTRAINT `fk_WAGONS_TRAINS1`
    ...
    REFERENCES `sql7147869`.`TRAINS` (`ID`)
    ON DELETE NO ACTION)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sql7147869`.`SEATS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`SEATS` (
  `ID` INT AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sql7147869`.`WAGON_SEAT_CONNECTION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`WAGON_SEAT_CONNECTION` (
  ...
  CONSTRAINT `fk_WAGON_SEAT_CONNECTION_SEATS1`
    ...
    REFERENCES `sql7147869`.`SEATS` (`ID`)
    ON DELETE NO ACTION,
  CONSTRAINT `fk_WAGON_SEAT_CONNECTION_WAGONS1`
    FOREIGN KEY (`WAGONS_ID`)
    REFERENCES `sql7147869`.`WAGONS` (`ID`)
    ON DELETE NO ACTION)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sql7147869`.`ROUTES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`ROUTES` (
  `ID` INT AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql7147869`.`TRAIN_ROUTE_CONNECTION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`TRAIN_ROUTE_CONNECTION` (
  ...
  CONSTRAINT `fk_TRAIN_ROUTE_CONNECTION_ROUTES1`
    ...
    REFERENCES `sql7147869`.`ROUTES` (`ID`)
    ON DELETE NO ACTION)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sql7147869`.`STATIONS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`STATIONS` (
  `ID` INT AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sql7147869`.`NEIGHBOURS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`NEIGHBOURS` (
  ...
  CONSTRAINT `fk_NEIGHBOURS_STATIONS1`
    ...
    REFERENCES `sql7147869`.`STATIONS` (`ID`)
    ON DELETE NO ACTION)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sql7147869`.`ROUTE_STATIONS_CONNECTION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`ROUTE_STATIONS_CONNECTION` (
...
-- -----------------------------------------------------
-- Table `sql7147869`.`TICKETS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`TICKETS` (
  `PRICE` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `sql7147869`.`USERS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`USERS` (
...
-- -----------------------------------------------------
-- Table `sql7147869`.`PURCHASES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql7147869`.`PURCHASES` (
  `ID` INT AUTO_INCREMENT,
  ...
  INDEX `fk_TICKETS_PURCHASES_idx` (`TICKET_TYPE` ASC),
  CONSTRAINT `fk_USERS_PURCHASES`
    FOREIGN KEY (`USER_NICKNAME`)
    REFERENCES `sql7147869`.`USERS` (`NICKNAME`)
    ON DELETE NO ACTION,
  CONSTRAINT `fk_TICKETS_PURCHASES`
    FOREIGN KEY (`TICKET_TYPE`)
    REFERENCES `sql7147869`.`TICKETS` (`TYPE`)
    ON DELETE NO ACTION)
ENGINE = InnoDB;
