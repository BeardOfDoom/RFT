SELECT *, START + INTERVAL DISTANCE_BEFORE_START/60.0*60.0 MINUTE AS 'START_TIME', START + INTERVAL (DISTANCE_BEFORE_START+DISTANCE_BETWEEN_START_AND_STOP)/60.0*60.0 MINUTE AS 'ARRIVE_TIME'
FROM WAGONS
INNER JOIN 
